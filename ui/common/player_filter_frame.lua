...
MTSLUI_PLAYER_FILTER_FRAME = {
    ...
    Initialise = function(self, parent_frame, filter_frame_name)
        ...
        self.ui_frame.sort_drop_down = MTSLUI_LIBS.DD:Create_UIDropDownMenu(filter_frame_name .. "_DD_SORTS", self.ui_frame) 
        ...
        MTSLUI_LIBS.DD:UIDropDownMenu_SetWidth(self.ui_frame.sort_drop_down, self.WIDTH_DD)
        MTSLUI_LIBS.DD:UIDropDownMenu_SetText(self.ui_frame.sort_drop_down, self.sorts[self.current_sort]["name"])
        ...
        self.ui_frame.realm_drop_down = MTSLUI_LIBS.DD:Create_UIDropDownMenu(filter_frame_name .. "_DD_REALMS", self.ui_frame)
        ...
        MTSLUI_LIBS.DD:UIDropDownMenu_SetWidth(self.ui_frame.realm_drop_down, self.WIDTH_DD)
        if self.current_realm > 0 then
            MTSLUI_LIBS.DD:UIDropDownMenu_SetText(self.ui_frame.realm_drop_down, MTSL_TOOLS:GetItemFromArrayByKeyValue(self.realms, "id", self.current_realms)["name"])
        else
            MTSLUI_LIBS.DD:UIDropDownMenu_SetText(self.ui_frame.realm_drop_down, MTSLUI_TOOLS:GetLocalisedLabel("any"))
        end
    ...
    ChangeRealm = function(self, id, text)
        ...
        MTSLUI_LIBS.DD:UIDropDownMenu_SetText(self.ui_frame.realm_drop_down, text)
    ...
    ChangeSorting = function(self, value, text)
        ...
        MTSLUI_LIBS.DD:UIDropDownMenu_SetText(self.ui_frame.sort_drop_down, text)
        -- Apply filter if we may
        if self:IsFilteringEnabled() then
