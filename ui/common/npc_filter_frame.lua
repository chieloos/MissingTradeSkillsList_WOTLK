...
MTSLUI_NPC_FILTER_FRAME = {
    ...
    InitialiseSecondRow = function (self)
        -- Factions drop down
        self.ui_frame.faction_drop_down = MTSLUI_LIBS.DD:Create_UIDropDownMenu(self.filter_frame_name .. "_DD_FACTIONS", self.ui_frame)
        ...
        MTSLUI_LIBS.DD:UIDropDownMenu_SetText(self.ui_frame.faction_drop_down, MTSLUI_TOOLS:GetLocalisedLabel("any faction"))
        -- Professions
        self.ui_frame.profession_drop_down = MTSLUI_LIBS.DD:Create_UIDropDownMenu(self.filter_frame_name .. "_DD_PROFS", self.ui_frame)
        ...
        MTSLUI_LIBS.DD:UIDropDownMenu_SetText(self.ui_frame.profession_drop_down, MTSLUI_TOOLS:GetLocalisedLabel("any profession"))
    end,
    ...
    InitialiseThirdRow = function (self)
        ...
        self.ui_frame.source_drop_down = MTSLUI_LIBS.DD:Create_UIDropDownMenu(self.filter_frame_name .. "_DD_SOURCES", self.ui_frame)
        ...
        MTSLUI_LIBS.DD:UIDropDownMenu_SetText(self.ui_frame.source_drop_down, MTSLUI_TOOLS:GetLocalisedLabel("any source"))
        -- create a filter for rank of trainer
        self.ui_frame.rank_drop_down = MTSLUI_LIBS.DD:Create_UIDropDownMenu(self.filter_frame_name .. "_DD_RANKS", self.ui_frame)
        ...
        MTSLUI_LIBS.DD:UIDropDownMenu_SetText(self.ui_frame.rank_drop_down, "")
    end,
    ...
    InitialiseFourthRow = function (self)
        ...
        self.ui_frame.continent_drop_down = MTSLUI_LIBS.DD:Create_UIDropDownMenu(self.filter_frame_name .. "_DD_CONTS", self.ui_frame)
        ...
        MTSLUI_LIBS.DD:UIDropDownMenu_SetText(self.ui_frame.continent_drop_down, MTSLUI_TOOLS:GetLocalisedLabel("any zone"))
        -- default continent "any" so no need for sub zone to show
        self.ui_frame.zone_drop_down = MTSLUI_LIBS.DD:Create_UIDropDownMenu(self.filter_frame_name .. "_DD_ZONES", self.ui_frame)
        ...
        MTSLUI_LIBS.DD:UIDropDownMenu_SetText(self.ui_frame.zone_drop_down, "")
    end,
    ...
    UpdateCurrentZone = function(self, new_zone_name)
        ...
        if new_zone ~= nil then
            ...
            if self.current_continent_id == nil and MTSLUI_LIBS.DD:UIDropDownMenu_GetText(self.ui_frame.continent_drop_down) ~= MTSLUI_TOOLS:GetLocalisedLabel("any zone") then
                MTSLUI_LIBS.DD:UIDropDownMenu_SetText(self.ui_frame.continent_drop_down, self.continents[2]["name"])
    ...
    ChangeSource = function(self, id, text)
        if id and id ~= self.filter_values["source"] then
            ...
            MTSLUI_LIBS.DD:UIDropDownMenu_SetText(self.ui_frame.source_drop_down, text)
            ...
            if id == "trainer" then
                ...
                MTSLUI_LIBS.DD:UIDropDownMenu_SetText(self.ui_frame.rank_drop_down, MTSLUI_TOOLS:GetLocalisedLabel("any rank"))
            else
    ...
    ChangeContinent = function(self, id, text)
        if id and id ~= self.filter_values["continent"] then
            MTSLUI_LIBS.DD:UIDropDownMenu_SetText(self.ui_frame.continent_drop_down, text)
            ...
            if id <= 0 then
                ...
                if zone then
                    MTSLUI_LIBS.DD:UIDropDownMenu_SetText(self.ui_frame.zone_drop_down, zone.name)
    ...
    ChangeFilter = function(self, name_filter, value_filter, dropdown_filter, dropdown_text)
        if value_filter and value_filter ~= self.filter_values[name_filter] then
            ...
            MTSLUI_LIBS.DD:UIDropDownMenu_SetText(dropdown_filter, dropdown_text)
            self:UpdateFilters()
        end
    end,
    ...
    ResizeToVerticalMode = function(self)
        ...
        for _, v in pairs(self.drop_down_names) do
            MTSLUI_LIBS.DD:UIDropDownMenu_SetWidth(_G[self.filter_frame_name .. v], self.WIDTH_DD)
        end
    end,
    ----------------------------------------------------------------------------------------------------------
